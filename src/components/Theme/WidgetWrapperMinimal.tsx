        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-3">
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              <div className="flex items-center gap-2 text-xs text-purple-700 dark:text-gray-400">
                <Clock className="h-3.5 w-3.5" />
                <span>Updated {new Date(widget.lastUpdated).toLocaleTimeString()}</span>
                <span className="px-2 py-0.5 rounded-full bg-white/70 dark:bg-gray-900/50 border">Every {widget.refreshInterval}s</span>
              </div>
