        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-3">
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              <div className="flex items-center gap-2 text-xs text-emerald-700 dark:text-gray-400">
                <Clock className="h-3.5 w-3.5" />
                <span>Updated {new Date(widget.lastUpdated).toLocaleTimeString()}</span>
                <span className="px-2 py-0.5 rounded-full bg-emerald-100/60 dark:bg-gray-800/60">Every {widget.refreshInterval}s</span>
              </div>
